...
The screens are shared by both platforms and hold no logic of the protocol. They show what the node holds, they perform acts by calling the host surface, and they report what came back. Everything the surface itself exposes and withholds belongs to [host-surface](../../mee-pdn/pdn-mobile/host/spec.md); what the demonstration shows belongs to [demo-scenario](../demo-scenario/spec.md).
