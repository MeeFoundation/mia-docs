...
The shape, whose store-level realization is specified in the [connection metadata store spec](../../components/mee-pdn/data-layer/connection-metadata-store/spec.md):
